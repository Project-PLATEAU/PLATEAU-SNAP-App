...
namespace iShapeUnity.Sample
{
    ...
    {
        [ReadOnly] internal PlainShape plainShape;

        [ReadOnly] internal bool isDelaunay;

        [WriteOnly] internal NativeArray<int> triangles;

        [WriteOnly] internal NativeArray<int> length;
